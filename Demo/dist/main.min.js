!function() {
    ...
    new Vue({
      el: "#app",
      data: {
        gas: "https://script.google.com/macros/s/AKfycbz25vpnjCtRWJYs6M8RUxnRNCQuYX8U3o61_ToNMDllS-u4tKj5LaE7daTIeecXP5__Vw/exec",
        name: "",
        id: "",
        persons: {},
        person: {},
        ...
        name: function(t) {
          ...
          if(this.name.lenth >2 || this.name.length <5)
            if (void 0 === this.persons[this.name]) {
              this.loading = !0;
              var i = this.gas + "?name=" + this.name + "&id=" + this.id;
              fetch(i, { method: "POST" })
                .then(function(t) {
                  return t.json();
                })
