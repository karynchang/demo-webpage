    ...
    new Vue({
      ...
      data: {
        ...
        input: {
          ...
          partment: 'entry.769254',   // 報到單表單欄位：學生部/青年部/一般/幼兒
      ...
      watch: {
        ...
        phone: function(t){
          if(t.length === 10){
            // 因為資料庫中的電話格式為 文字，且顯示格式為 OOOO-OOO-OOO，所以要將使用者輸入的10碼數字轉換成手機格式 OOOO-OOO-OOO
            ...
            var n = this;       
            this.loading = !0;
            var i = this.gas + "?name=" + this.name + "&phone=" + formatPhone; // formatPhone須和資料庫中格式相同才能順利查詢
            fetch(i, { method: "POST" })
              .then(function(t) {
                return t.json();
              })
