!function() {
    ...
    new Vue({
      ...
      data: {
        ...
        gas: "https://script.google.com/macros/s/AKfycbwYiMXAzXXho5CmxVz7VqWFgng7zDCsqHSmoiNLksoxDxTioXrQaBx5HNTDZt3zqjQWtw/exec",
        name: "",     // 清空name
        phone: "",    // 清空phone
        persons: {},  // 清空persons
        person: {},   // 清空person

        // 報到單頁面點選F12，在元素頁籤中查詢 "<form"，可以找到以下連結
        formAction: "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfLFQnkyH0pjGjZbFV-dw_O1Z7oAJ9SDgd4lO34BVFLRwi7tA/formResponse",
        
        input: {
          id:'entry.1339314469',      // 報到單問卷欄位：ID
          name: 'entry.2132758197',   // 報到單問卷欄位：姓名
          gender: 'entry.1833440644', // 報到單問卷欄位：性別
          phone: 'entry.1937240046',  // 報到單問卷欄位：電話
          area: 'entry.2050668982',   // 報到單問卷欄位：地區
          org_1: 'entry.435100097',   // 報到單問卷欄位：系統
          org_2: 'entry.1577594074',  // 報到單問卷欄位：(準)支部/法座
          age: 'entry.152815214',     // 報到單問卷欄位：年齡
          partment: 'entry.769254',   // 報到單問卷欄位：學生部/青年部/一般/幼兒
          note: 'entry.1172474453'    // 報到單問卷欄位：備註
        },
        ...
        submit: function() {
          ...
          if (void 0 !== this.person.area) {
            var n = ""
              ...
              .concat(this.input.partment, "=")
              .concat(this.person.partment, "&")
