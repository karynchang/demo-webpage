  ...
  new Vue({
    ...
    data: {
      ...
      input: {
        ...
        name_n: 'entry.2132758197',      // 首次登錄表單欄位：姓名
        gender_n: 'entry.484563647',     // 首次登錄表單欄位：性別
        phone_n: 'entry.1937240046',     // 首次登錄表單欄位：電話
        area_n: 'entry.2050668982',      // 首次登錄表單欄位：地區
        district_n: 'entry.527397194',   // 首次登錄表單欄位：座談會地區
        org_1_n: 'entry.883603394',      // 首次登錄表單欄位：系統
        org_2_n: 'entry.686627579',      // 首次登錄表單欄位：支部/準支部/法座
        birth_year: 'entry.1818800730',       // 首次登錄表單欄位：出生年份
        dept_n: 'entry.769254',          // 首次登錄表單欄位：學生部/青年部/一般/幼兒
        join_type_n: 'entry.57473509',   // 首次登錄表單欄位：參加形式
        consent_n: 'entry.1350156201'    // 首次登錄表單欄位：同意資料蒐集
      },
              ...
              if (phoneLength === 2 && void 0 === t.area) {
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    // 如果用戶點擊了確認按鈕，執行相應的操作
                    window.location.href = 'First_Registration.html';
                    n.name = "";
                    n.phone = "";
                    n.join_type = "" ;
                  } else {
      ...
      console.log("點選修改")
          ...
          submit_n: function() {
            ...
            var t = this;
              ...
              var n = ""
                .concat(this.input.name_n, "=")
                .concat(this.person.name, "&")
                .concat(this.input.gender_n, "=")
                .concat(this.person.gender, "&")
                .concat(this.input.birth_year, "=")
                .concat(this.person.birth_year, "&")
                .concat(this.input.phone_n, "=")
                .concat(this.person.phone, "&")
                .concat(this.input.area_n, "=")
                .concat(this.person.area, "&")
                .concat(this.input.district_n, "=")
                .concat(this.person.district, "&")
                .concat(this.input.org_1_n, "=")
                .concat(this.person.org_1, "&")
                .concat(this.input.org_2_n, "=")
                .concat(this.person.org_2, "&")
                .concat(this.input.dept_n, "=")
                .concat(this.person.dept, "&")
                .concat(this.input.join_type_n, "=")
                .concat(this.person.join_type, "&")
                .concat(this.input.date, "=")
                .concat(this.person.date, "&")
