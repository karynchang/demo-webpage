!function() {
  ...
  new Vue({
      ...
      submit: function() {
        ...
        if (void 0 !== this.person.area) {
          ...
          fetch(this.formAction + "?" + n, { method: "POST" }).catch(function(n) {
            alert(submitdata), t.name = "",t.phone="", t.person = {join_type : "實體" }, t.persons ={};
    ...
    confirmName: function() {
      ...
      // if(this.name.length >= 2 && this.name.length < 7 ){  // 2 <= 名字長度 <= 6
        if (void 0 === this.persons[this.name]) {
          ...
          n.person = {join_type : "實體" }, n.persons ={};
        } 
        else {
    ...
    wrongData(){
      ...
      Swal.fire({
        title: '<div style="font-weight: bold;">請選擇資料錯誤原因',
        html: '<div style="text-align: left;">少部分資料錯誤 <br>  → 請點選 修改資料。<br><br>資料全部錯誤 <br>   → 請點選 改用電話查詢。',
        icon: 'warning',
        showCancelButton: true,
