!function() {
  ...
  new Vue({
    ...
    data: {
      ...
      gas: "https://script.google.com/macros/s/AKfycbxUOIVjkXKo30eRba_XK0aSRYcb980QU8pDrxPr0ieE9Fr9liMZn7sSQOqyAYpd-nZVMA/exec",
      name: "",     // 清空name
      phone: "",    // 清空phone
      persons: {},  // 清空persons
      person: {},   // 清空person
          ...
          fetch(i, { method: "POST" })
            ...
            .then(function(t) {
              n.persons[n.name] = t, 
                ...
                if(phoneLength === 10 && void 0 ===  t.area ) {
                  // 輸入名字及電話後，找不到資料會跳提示框 (電話10碼找不到資料才會跳提示框)
                  alert('您尚未登錄資料。 \n請點選確定後填寫資料。');
